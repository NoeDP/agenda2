...
class dashboard extends Controller
{
    public function dashboard(){
        ...
        $organizadores = Organizador::withoutTrashed()->paginate(5); // Solo los que no están eliminados
        $foros = Foro::withoutTrashed()->paginate(5); // Solo los que no están eliminados
        $users = User::withoutTrashed()->paginate(5); // Si los usuarios tienen SoftDeletes
        $eventos = Evento::withoutTrashed()->paginate(5); // Solo los eventos activos
